...
Original file is located at
    https://colab.research.google.com/drive/1-2wROsKTxHhRjSKLCsTDsZJM3bFRCdsy
"""
...
with open('NAND_strat_30.pkl', 'rb') as f:
...
for i in range(10):
    NAND_network = restricted_NAND_network([9, 9, 9, 6, 3, 2, 1], [9])
    NAND_network.load_mixed_strategy(strats[i])
    ...
    strat, entropies, val_score, train_score = train_model_restricted(NAND_network, 0.001, 50, 0, train_dataset, val_dataset)
...
with open('NAND_train_80.pkl', 'wb') as f:
    pickle.dump(classifier_train_scores, f)
    
with open('NAND_val_80.pkl', 'wb') as f:
    pickle.dump(classifier_validation_scores, f)
    
with open('NAND_strat_80.pkl', 'wb') as f:
    pickle.dump(classifier_strategies, f)
    
with open('NAND_entropies_80.pkl', 'wb') as f:
